...
export function EventHallSection() {
  return (
        ...
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-white/80 sm:text-xl">
              Contamos con un salón de eventos especialmente diseñado para
              compartir esas reuniones importantes con tu empresa, familiares o
              amigos. Un espacio único para celebrar momentos inolvidables.
            </p>
          </div>
        </Reveal>
      </div>
