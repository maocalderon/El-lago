...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        premium: "0 24px 70px rgba(137, 207, 240, 0.2)",
        soft: "0 14px 40px rgba(137, 207, 240, 0.12)",
        "glow-blue": "0 0 30px rgba(79, 195, 247, 0.3)",
        "glow-gold": "0 0 30px rgba(245, 184, 32, 0.25)"
      },
      backgroundImage: {
        "lago-radial": "radial-gradient(circle at 15% 20%, rgba(79, 195, 247, 0.15), transparent 28%), linear-gradient(135deg, #89cff0 0%, #5ba3c9 52%, #89cff0 100%)",
